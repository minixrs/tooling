...
(cross-repo rule). `patches/llvm/` holds the series — 0001–0005 are P2b's,
0006 is P3b's — as
...
```sh
verify/check-driver.sh      # exits 0 (crt/sysroot assertions active since P3a)
...
verify/check-driver.sh                 # crt/sysroot assertions ACTIVE since P3a
